...
\hypersetup{
	colorlinks=true,
	linkcolor=black,  % Colore dei link nell'indice
	pdfborder={0 0 0} % Nessun bordo attorno ai link
	linkcolor=[HTML]{1A73E8}, % Blu carino (puoi cambiarlo)
	urlcolor=[HTML]{1A73E8},  % Stesso blu per i link URL
	citecolor=[HTML]{0077CC}, % Blu più scuro per le citazioni
	filecolor=[HTML]{0077CC}, % Blu più scuro per i file linkati
}
%%%%%%% FINE PREAMBOLO %%%%%%%
...
\begin{table}[h]
	\centering
	\large % Aumenta la dimensione del testo nella tabella
	\begin{tabular}{|c|c|c|}
		\hline
