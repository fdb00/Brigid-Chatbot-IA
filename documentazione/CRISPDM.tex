...
\end{itemize}
Questo test aiuta a identificare situazioni in cui il modello potrebbe fare errori e assicura che, in caso di bassa confidenza, la chatbot possa eventualmente ricorrere a un fallback come Gemini.
...
\begin{itemize}
	...
	\item Pulizia e normalizzazione dei dati, per eliminare rumore e incoerenze che potrebbero influenzare la qualità dell’addestramento.
	\item Suddivisione del dataset in \textbf{training} e \textbf{validation set}, migliorando l'accuratezza e la valutazione del modello.
\end{itemize}
